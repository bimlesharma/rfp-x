            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                ...
                <div className="gradient-purple p-6 text-white">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-xl font-semibold">Input RFP Document</h2>
                    </div>
                ...
                <div className="p-6 border-b">
                    <div className="flex gap-4">
                        <button
                            ...
                            className={`flex-1 py-3 px-4 rounded-lg font-medium transition-all ${inputMode === "mock"
                        ...
                        <button
                            ...
                            className={`flex-1 py-3 px-4 rounded-lg font-medium transition-all ${inputMode === "custom"
                                    ? "bg-purple-600 text-white shadow-md"
                                    : "bg-gray-100 text-gray-700 hover:bg-gray-200"
                                }`}
                        >
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    ...
                    <button
                        type="submit"
                        className="mt-6 w-full py-4 gradient-purple text-white font-semibold rounded-lg hover:opacity-90 transition-opacity flex items-center justify-center gap-2"
                    >
